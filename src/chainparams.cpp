...
public:
    CMainParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
			  cout << "new primary chain genesis merkle root: " << genesis.hashMerkleRoot.ToString().c_str() << endl;
        cout << "new primary chain genesis nonce: " << genesis.nNonce.ToString().c_str() << endl;
        cout << "new primary chain genesis hash: " <<  genesis.GetHash().ToString().c_str() << endl;
